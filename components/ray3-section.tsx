      ...
      <div className="mx-auto max-w-7xl px-0 sm:px-6">
        <div className="grid sm:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            >
              <p className="text-sm/10 sm:text-base/8 text-dark-muted leading-relaxed mb-8 max-w-md text-balance ">
                Soy un{" "}
          ...
          <motion.div className="px-3 block lg:hidden">
            <motion.h2
              ...
              animate={isInView ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.8, delay: 0.3, ease: "easeInOut" }}
              className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white/90 mb-8 uppercase ml-20 "
            >
              acerca de mí
            </motion.h2>
            ...
            <motion.div
              ...
              className="flex flex-wrap gap-3"
            >
              <p className="text-base/10 text-dark-muted leading-relaxed mb-8 max-w-xs text-left text-balance ml-11 ">
                Soy un{" "}
                <span className="text-dark-fg font-semibold">
                  desarrollador full stack
                </span>{" "}
